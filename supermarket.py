...
class ExtractData:
    def __int__(self, purchase_data_dir=None):
...
#
#     def get_file_names_from_dir(self):
#         self.purchase_files_list = [f for f in os.listdir(self.purchase_data_dir) if os.path.isfile(os.path.join(self.purchase_data_dir, f))]
